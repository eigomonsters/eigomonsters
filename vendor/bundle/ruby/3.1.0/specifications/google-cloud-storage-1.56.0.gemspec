...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<google-apis-core>.freeze, ["~> 0.13"])
    s.add_dependency(%q<google-apis-iamcredentials_v1>.freeze, ["~> 0.18"])
    s.add_dependency(%q<google-apis-storage_v1>.freeze, [">= 0.42"])
    ...
    s.add_dependency(%q<google-style>.freeze, ["~> 1.30.0"])
