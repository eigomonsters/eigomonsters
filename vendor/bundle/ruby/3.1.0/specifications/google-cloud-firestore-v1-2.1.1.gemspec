# -*- encoding: utf-8 -*-
# stub: google-cloud-firestore-v1 2.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<google-cloud-location>.freeze, ["~> 1.0"])
  else
    s.add_dependency(%q<gapic-common>.freeze, ["~> 1.0"])
    s.add_dependency(%q<google-cloud-errors>.freeze, ["~> 1.0"])
    s.add_dependency(%q<google-cloud-location>.freeze, ["~> 1.0"])
  end
end
