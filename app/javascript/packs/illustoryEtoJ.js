...
window.addEventListener('load', function(){
  ...
  questionWord.onclick = function() {
    pronounce(questionWord.textContent);
  }
  ...
  function illustoryTextAboveDisplay() {
    ...
    storyAbove.classList.add('storyAboveWidth');
    storyAboveText1.textContent = storyList[j].eng_sentence;
    storyAboveText2.textContent = storyList[j+1].eng_sentence;
    storyAboveText3.textContent = storyList[j+2].eng_sentence;
  }
  ...
  function illustoryTextDisplay() {
    if (j%3 == 0) {
      ...
      storyEngText.className = "storyEngTextEtoJ";
    }
    storyJapText.textContent = "";
    storyJapText.className = "transparent";
    ...
    // １つの例文で使用される問題となる４つの英単語
    questionWord1 = engWord1JapTrans[0].eng_word;
    questionWord2 = engWord2JapTrans[0].eng_word;
    questionWord3 = engWord3JapTrans[0].eng_word;
    questionWord4 = engWord4JapTrans[0].eng_word;
    // １つの例文で使用される問題となる４つの英単語の英単語の日本語訳１
    answerWord1 = engWord1JapTrans[0].jap_trans_1;
    answerWord2 = engWord2JapTrans[0].jap_trans_1;
    answerWord3 = engWord3JapTrans[0].jap_trans_1;
    answerWord4 = engWord4JapTrans[0].jap_trans_1;
    ...
    answerWord1JapTrans2 = engWord1JapTrans[0].jap_trans_2;
    answerWord2JapTrans2 = engWord2JapTrans[0].jap_trans_2;
    answerWord3JapTrans2 = engWord3JapTrans[0].jap_trans_2;
    answerWord4JapTrans2 = engWord4JapTrans[0].jap_trans_2;
    answerWord1JapTrans3 = engWord1JapTrans[0].jap_trans_3;
    answerWord2JapTrans3 = engWord2JapTrans[0].jap_trans_3;
    answerWord3JapTrans3 = engWord3JapTrans[0].jap_trans_3;
    answerWord4JapTrans3 = engWord4JapTrans[0].jap_trans_3;
    answerWord1JapTrans4 = engWord1JapTrans[0].jap_trans_4;
    answerWord2JapTrans4 = engWord2JapTrans[0].jap_trans_4;
    answerWord3JapTrans4 = engWord3JapTrans[0].jap_trans_4;
    answerWord4JapTrans4 = engWord4JapTrans[0].jap_trans_4;
    // 問題となる例文を作成
  ...
  function questionWordDisplay() {
    if (k ==0) {
      ...
      answerWordCorrectJapTrans2 = answerWord1JapTrans2;
      answerWordCorrectJapTrans3 = answerWord1JapTrans3;
      answerWordCorrectJapTrans4 = answerWord1JapTrans4;
      ...
      answerWordCorrectJapTrans2 = answerWord2JapTrans2;
      answerWordCorrectJapTrans3 = answerWord2JapTrans3;
      answerWordCorrectJapTrans4 = answerWord2JapTrans4;
    } else if (k==2) {
      questionWord.textContent = questionWord3;
      answerWordCorrect = answerWord3;
      partOfSpeechCorrect = partOfSpeech3;
      answerWordCorrectJapTrans2 = answerWord3JapTrans2;
      answerWordCorrectJapTrans3 = answerWord3JapTrans3;
      answerWordCorrectJapTrans4 = answerWord3JapTrans4;
    } else {
      questionWord.textContent = questionWord4;
      answerWordCorrect = answerWord4;
      partOfSpeechCorrect = partOfSpeech4;
      answerWordCorrectJapTrans2 = answerWord4JapTrans2;
      answerWordCorrectJapTrans3 = answerWord4JapTrans3;
      answerWordCorrectJapTrans4 = answerWord4JapTrans4;
    }
    pronounce(questionWord.textContent);
    optionCreate();
    ...
    allQuestionWords = [];
    allQuestionWords.push(j % 3 * 4 + k + 1, j * 4 + k + 1,"▷" ,questionWord.textContent, answerWordCorrect, "○");
  }
  ...
  function optionCreate() {
    ...
    while ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption1Incorrect].eng_word)
          || (((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_4 != ""))) {
    ...
    while ((randomIntegerOption1Incorrect == randomIntegerOption2Incorrect)
          || (((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_4 != ""))) {
    ...
    while (((randomIntegerOption1Incorrect == randomIntegerOption3Incorrect) || (randomIntegerOption2Incorrect == randomIntegerOption3Incorrect))
          || (((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3 != "")
          || ((answerWordCorrect == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4) && answerWordCorrect != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans2 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4) && answerWordCorrectJapTrans2 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans3 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4) && answerWordCorrectJapTrans3 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_2 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_3 != "")
          || ((answerWordCorrectJapTrans4 == engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4) && answerWordCorrectJapTrans4 != "" && engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_4 != ""))){
    ...
    if (randomIntegerOptionCorrect == 0) {
      ...
      optionAnswer2.textContent = `2. ${engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1}`;
      optionAnswer3.textContent = `3. ${engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1}`;
      optionAnswer4.textContent = `4. ${engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1}`;
    } else if (randomIntegerOptionCorrect == 1) {
      optionAnswer1.textContent = `1. ${engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1}`;
      optionAnswer2.textContent = `2. ${answerWordCorrect}`;
      optionAnswer3.textContent = `3. ${engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1}`;
      optionAnswer4.textContent = `4. ${engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1}`;
    } else if (randomIntegerOptionCorrect == 2) {
      optionAnswer1.textContent = `1. ${engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1}`;
      optionAnswer2.textContent = `2. ${engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1}`;
      optionAnswer3.textContent = `3. ${answerWordCorrect}`;
      optionAnswer4.textContent = `4. ${engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1}`;
    } else {
      optionAnswer1.textContent = `1. ${engWordOptionIncorrect[randomIntegerOption1Incorrect].jap_trans_1}`;
      optionAnswer2.textContent = `2. ${engWordOptionIncorrect[randomIntegerOption2Incorrect].jap_trans_1}`;
      optionAnswer3.textContent = `3. ${engWordOptionIncorrect[randomIntegerOption3Incorrect].jap_trans_1}`;
  ...
  function optionAnswerFontSizeAdjust() {
    ...
    optionAnswer4.className = "optionAnswerNormal";
      if (optionAnswer1.textContent.length - 3 > 12) {
        optionAnswer1.classList.add('optionAnswerFontPattern3');
      } else if(optionAnswer1.textContent.length - 3 > 7) {
        optionAnswer1.classList.add('optionAnswerFontPattern4');
      }
      if (optionAnswer2.textContent.length - 3 > 12) {
        optionAnswer2.classList.add('optionAnswerFontPattern3');
      } else if(optionAnswer2.textContent.length - 3 > 7) {
        optionAnswer2.classList.add('optionAnswerFontPattern4');
      }
      if (optionAnswer3.textContent.length - 3 > 12) {
        optionAnswer3.classList.add('optionAnswerFontPattern3');
      } else if(optionAnswer3.textContent.length - 3 > 7) {
        optionAnswer3.classList.add('optionAnswerFontPattern4');
      }
      if (optionAnswer4.textContent.length - 3 > 12) {
        optionAnswer4.classList.add('optionAnswerFontPattern3');
      } else if(optionAnswer4.textContent.length - 3 > 7) {
        optionAnswer4.classList.add('optionAnswerFontPattern4');
      }
  }
