...
window.addEventListener('load', function () {
  ...
  var imgArray = ['/assets/メーターPNG/メーター0.png', '/assets/メーターPNG/メーター10.png']; // document.getElementById("meterImg").src=imgArray[bonusCount];
});

/***/ })

/******/ });
//# sourceMappingURL=typingplay-42f800bc751129cef1da.js.map