  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        console.log(duplicateWords[0].displayWordInList.id); // if (duplicateWords.length > 1) {
        // 	for (let i = 1; i < duplicateWords.length; i++) {
        // 		if (duplicateWords[i].displayWordInList.id){
        // 		}
        // 	}
        // }
...
/******/ });
//# sourceMappingURL=typingplay_eng-167d4f1c5758c1597a32.js.map