...
window.addEventListener('load', function () {
  ...
  function createText() {
    ...
    checkTexts = wordList[randomIntegerInTotalWordList].split("").map(function (values) {
      // 例) spanValue = <span>a</span>
      var spanValue = document.createElement("span"); // 例) value = a

      spanValue.textContent = values;
...
/******/ });
//# sourceMappingURL=typingplay-d9cb6110763769c171ce.js.map