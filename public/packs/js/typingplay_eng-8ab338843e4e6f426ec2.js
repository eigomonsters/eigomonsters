...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function correctTyping() {
      ...
      if (agent.indexOf("chrome") != -1 && charArrayInDisplayWord[0].textContent == "f" && charArrayInDisplayWord.length > 1 && charArrayInDisplayWord[1].textContent == "f" && addHalfRedFlag == "0") {
      ...
      && charArrayInDisplayWord[0].textContent == "f" && charArrayInDisplayWord.length > 1 && charArrayInDisplayWord[1].textContent == "f" && addHalfRedFlag == "1") {
...
/******/ });
//# sourceMappingURL=typingplay_eng-8ab338843e4e6f426ec2.js.map