    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        var fileExists = /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(filePath) {
        ...
        displayWordInList = wordList[randomIntegerInTotalWordList]; //let filePath = '/assets/'+ displayWordInList.eng_word + '.mp3';

        var fs = __webpack_require__(/*! fs */ "./node_modules/node-libs-browser/mock/empty.js").promises;

        fileExists('/assets/' + displayWordInList.eng_word + '.mp3').then(function (res) {
...
/******/ });
//# sourceMappingURL=typingplay_jap-2bf1b046dde69bb172fe.js.map