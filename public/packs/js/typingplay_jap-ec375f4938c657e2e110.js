  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        pronounce(displayWordInList.eng_word); // 第一問のみ発音が再生されないため、自動再生処理を定義する。

        setTimeout(pronounce(displayWordInList.eng_word), 100); // 英単語を表示させる。
...
/******/ });
//# sourceMappingURL=typingplay_jap-ec375f4938c657e2e110.js.map