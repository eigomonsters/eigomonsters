...
window.addEventListener('load', function () {
  ...
  var initialPlayingTimeMSec = 6000; // スタート時に残りのプレイ可能時間の初期値を表示する。

  remainPlayingTime.textContent = Math.ceil(initialPlayingTimeMSec / 1000); // const closePopup = document.getElementById("closePopup");
  // let endFlag = "0";
  ...
  var addScoreLevel2 = 3; // setTimeout(countUpScore,0);
  // スコアアップする処理を定義する。
  ...
  function keyDownCharCountUp(keyDownChar) {
    ...
    if (bonusCountMeter >= bonusCountMeterMax) {
      bonusCountMeter = 0; // 初期プレイ時間を更新することで、
...
/******/ });
//# sourceMappingURL=typingplay-2ec324612eec8a014164.js.map