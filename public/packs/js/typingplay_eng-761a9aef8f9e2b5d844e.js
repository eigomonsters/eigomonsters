...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      var remainSecLabel = "\u6B8B\u308A".concat("0".concat(remainMin), "\u5206", "0".concat(remainSec).slice(-2), "\u79D2"); // 残り時間が0になった場合の処理を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-761a9aef8f9e2b5d844e.js.map