...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    var addScoreLevel1 = 100;
    var addScoreLevel2 = 300; // 表示する正解数を定義する。
    ...
    function countUpScore() {
      ...
      test.setAttribute('data-num', totalScore);
      var countElm = $('.count'),
          countSpeed = 10;
...
/******/ });
//# sourceMappingURL=typingplay_jap-468c3d15b15f8c1be262.js.map