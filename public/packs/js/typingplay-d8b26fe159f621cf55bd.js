...
window.addEventListener('load', function () {
  ...
  function countDownTime() {
    ...
    if (remainMSec <= 0) {
      ...
      closePopup.className = "closePopup"; // 2秒後に得点を表示させる。

      setTimeout(function () {
        closePopup.textContent = "\u3042\u306A\u305F\u306E\u5F97\u70B9\u306F".concat(totalScore, "\u70B9\u3067\u3059!");
        closePopup.className = "endResultPopup";
      }, 2000); // 3秒後に戻るボタンを表示させる。

      var backBtnPopup = document.getElementById("backBtnPopup");
      setTimeout(function () {
        backBtnPopup.textContent = "\u623B\u308B";
        backBtnPopup.className = "backBtnPopup";
      }, 3000);
    } // 残りプレイ可能時間を更新する。
...
/******/ });
//# sourceMappingURL=typingplay-d8b26fe159f621cf55bd.js.map