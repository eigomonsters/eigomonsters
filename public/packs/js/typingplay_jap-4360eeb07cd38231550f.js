...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    var charArrayInDisplayWordJap = [];
    charArrayInDisplayWordJap.classList.add('transparent'); // 表示する単語を作成する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-4360eeb07cd38231550f.js.map