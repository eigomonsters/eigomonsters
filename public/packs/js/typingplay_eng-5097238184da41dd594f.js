...
function gameStart() {
  ...
  var timerIdToStart = setInterval(countDownTimeToStart, 0); // ゲーム開始までをカウントダウンを実施する処理を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-5097238184da41dd594f.js.map