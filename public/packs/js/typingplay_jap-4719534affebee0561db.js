...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      var remainSecLabel = "\u6B8B\u308A".concat("".concat(remainMin).slice(-1), "\u5206").concat("00".concat(remainSec).slice(-3), "\u79D2");
...
/******/ });
//# sourceMappingURL=typingplay_jap-4719534affebee0561db.js.map