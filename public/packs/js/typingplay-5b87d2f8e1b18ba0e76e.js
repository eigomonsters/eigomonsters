...
window.addEventListener('load', function () {
  ...
  var initialPlayingTimeMSec = 6000; // 表示する残りのプレイ可能時間に初期値を設定する。

  remainPlayingTime.textContent = initialPlayingTimeMSec; // const closePopup = document.getElementById("closePopup");
  // let endFlag = "0";
...
/******/ });
//# sourceMappingURL=typingplay-5b87d2f8e1b18ba0e76e.js.map