...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      console.log(shiftAlreadyStartedCountFirst);
      console.log(shiftAlreadyStartedCountSecond);
      console.log(shiftAlreadyStartedCountThird);
      console.log(shiftAlreadyStartedCountSoleFirst);
      console.log(shiftAlreadyStartedCountSoleSecond);
      console.log(shiftAlreadyStartedCountSoleThird); // 最後の文字でない場合
...
/******/ });
//# sourceMappingURL=typingplay_jap-de90dce18a2686568193.js.map