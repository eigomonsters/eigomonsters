...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      if (charArrayInDisplayWord[0].textContent + charArrayInDisplayWord[1].textContent === "きょ" && keyDownChar.key === "k") {
        if (keyDownChar.key === "y") {
          if (keyDownChar.key === "o") {
            charArrayInDisplayWord[0].className = "add_red";
            charArrayInDisplayWord[1].className = "add_red";
          }
        }
      }
...
/******/ });
//# sourceMappingURL=typingplay_jap-7844be58ab645afd3e96.js.map