...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    displayNumCorrectNum.className = "displayNumCorrectNum"; // 初期値を定義する。

    displayNumCorrectNum.textContent = 0; // 表示する連続正解数を定義する。

    var displayConsecutiveNumCorrectNum = document.getElementById("displayConsecutiveNumCorrectNum");
    displayConsecutiveNumCorrectNum.className = "displayConsecutiveNumCorrectNum"; // 初期値を定義する。

    displayConsecutiveNumCorrectNum.textContent = 0; // 表示する最高連続正解数を定義する。

    var displayMaxConsecutiveNumCorrectNum = document.getElementById("displayMaxConsecutiveNumCorrectNum");
    displayMaxConsecutiveNumCorrectNum.className = "displayMaxConsecutiveNumCorrectNum"; // 初期値を定義する。

    displayMaxConsecutiveNumCorrectNum.textContent = 0; // 以上、スコア定義---------------------------------------------------------------------------------------------------
...
/******/ });
//# sourceMappingURL=typingplay_eng-cb47b8abdcf845740973.js.map