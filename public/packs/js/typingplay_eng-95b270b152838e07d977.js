  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        var duplicateWords = wordList.indexOf(displayWordInList.jap_trans_1);
        console.log(displayWordInList.jap_trans_1);
        console.log(duplicateWords); // 表示する単語を一文字ごとに区切り、spanタグで閉じる。
        // spanタグで閉じた単語を表示する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-95b270b152838e07d977.js.map