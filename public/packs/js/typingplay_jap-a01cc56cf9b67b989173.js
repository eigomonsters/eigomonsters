...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    var charArrayInDisplayWordJap = []; // プレイモード練習の場合は、答えとして漢字も表示する。
    // ゲーム終了を判定するフラグを定義する。
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        displayWordKanji.className = "displayWordKanji"; // 表示する単語を一文字ごとに区切り、spanタグで閉じる。
        // spanタグで閉じた単語を表示する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-a01cc56cf9b67b989173.js.map