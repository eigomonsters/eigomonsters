      ...
      setTimeout(function () {
        ...
        if (playMode == "練習" || playMode == "普通") {
          ...
          if (gameCompleteTimeAttackFlag == "1") {
            ...
            closePopup.textContent = "\u3042\u306A\u305F\u304C\u304B\u304B\u3063\u305F\u6642\u9593\u306F".concat("".concat(remainMinTimeAttack).slice(-1), "\u5206").concat("".concat(remainSecTimeAttack).slice(-1), "\u79D2\u3067\u3059!");
            closePopup.className = "endResultPopup";
          } else {
...
/******/ });
//# sourceMappingURL=typingplay_eng-76f38818daf0ef533d10.js.map