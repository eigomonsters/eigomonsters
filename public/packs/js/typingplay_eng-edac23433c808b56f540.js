...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function gameClose() {
      ...
      var checkQuestions = document.getElementById("checkQuestions"); // 2秒後に得点を表示させる。また、もう一度ボタンと戻るボタンを表示させる。
      ...
      setTimeout(function () {
        ...
        checkQuestions.onclick = function () {
          // メーターを非表示にする。
          document.getElementById("meterImg").className = "transparent"; // 出題問題リストを表示させる。にする。
          ...
          allQuestionsList.innerHTML = allQuestionWordsList;
...
/******/ });
//# sourceMappingURL=typingplay_eng-edac23433c808b56f540.js.map