  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        allQuestionWords.push(displayWordInList.id, displayWordInList.eng_word, displayWordInList.jap_trans_1, "未解答"); //表示する単語の発音させる。（発音ありの場合のみ）
    ...
    function gameClose() {
      ...
      if (!(playMode == "タイムアタック" && gameCompleteTimeAttackFlag == "1") && allQuestionWords[allQuestionWords.length - 1] == "未解答") {
        // 出題したすべての英単語リストに追加する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-765fe68ed380a871a855.js.map