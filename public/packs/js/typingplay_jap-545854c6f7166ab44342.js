...
function gameStart() {
  ...
  var _sortById = 69; // 正解音を定義する。

  var correctAudio = new Audio('/assets/正解音.mp3'); // 不正解音を定義する。

  var incorrectAudio = new Audio('/assets/不正解音.mp3'); // 表示するメーター初期値を定義する。
  ...
  function typingPlayStart() {
    ...
    function correctTyping() {
      ...
      if (charArrayInDisplayWordJap.length === 0) {
        console.log(correctAudio); // 正解した場合、効果音を発生させる。
...
/******/ });
//# sourceMappingURL=typingplay_jap-545854c6f7166ab44342.js.map