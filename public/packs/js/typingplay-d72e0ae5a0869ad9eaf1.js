...
window.addEventListener('load', function () {
  ...
  var wordList = [gon.wordlist.map(function (value) {
    console.log(value);
    return value.eng_word;
  })];
  console.log(wordList);
  var questionLists = ["corpse", "marsh", "cripple", "lieutenant", "deafen", "doom", "intensive", "plaster"];
  console.log(questionLists); // 表示するメーターリストを定義する。
...
/******/ });
//# sourceMappingURL=typingplay-d72e0ae5a0869ad9eaf1.js.map