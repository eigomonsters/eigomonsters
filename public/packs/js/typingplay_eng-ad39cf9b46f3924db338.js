...
window.addEventListener('load', function gameStart() {
  // 表示する単語リストを定義する。
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        setTimeout(function () {
          ...
          restartBtn.addEventListener('click', function gameStart() {}); //restartBtn.innerHTML = "<a href='./typingplay_eng'>もう一度遊ぶ</a>";

          restartBtn.className = "restartBtn";
          backBtn.innerHTML = "<a href='./typingplay_eng'>コース選択画面に戻る</a>";
...
/******/ });
//# sourceMappingURL=typingplay_eng-ad39cf9b46f3924db338.js.map