...
window.addEventListener('load', function () {
  ...
  var countDownPopupNumber = document.getElementById("countDownPopup");
  countDownPopupNumber.textContent = 3;
  var timerIdToStart = setInterval(countDownTimeToStart, 1000);

  function countDownTimeToStart() {
    countDownPopupNumber = (_readOnlyError("countDownPopupNumber"), countDownPopupNumber - 1);
    console.log(countDownPopupNumber);

    if (countDownPopupNumber <= 0) {
      clearInterval(timerIdToStart);
      typingPlayStart;
    } else {
      countDownPopupNumber.textContent = countDownPopupNumber;
    }
  } // ゲームを開始する処理を定義する。
...
/******/ });
//# sourceMappingURL=typingplay-d285f3773b27d2d1394a.js.map