...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function gameClose() {
      ...
      allQuestionsLists.forEach(function (allQuestionsList) {
        // 配列の中のオブジェクトの数だけ処理を繰り返す
        var tr = document.createElement("tr");
        playerList.appendChild(tr); // 表の中に８個の「tr」（行）ができる
        // 1行の中を生成

        var objArray = Object.entries(allQuestionsList); // オブジェクトを配列に
...
/******/ });
//# sourceMappingURL=typingplay_eng-8465331f88421e58b838.js.map