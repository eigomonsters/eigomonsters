...
function gameStart() {
  ...
  var timerIdToStart = setInterval(countDownTimeToStart, 1000); // メーターの初期値を表示する。
  ...
  countDownPopup.textContent = countDownPopupNumber; // ゲーム開始までをカウントダウンを実施する処理を定義する。
  ...
  function countDownTimeToStart() {
    ...
    countDownPopup.textContent = countDownPopupNumber; //カウントダウンが0になれば、ゲームを開始する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-98956d2456178c677c25.js.map