  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        var restartBtnTest = document.getElementById("restartBtnTest"); // 2秒後に得点を表示させる。また、もう一度ボタンと戻るボタンを表示させる。

        setTimeout(function () {
          closePopup.textContent = "\u3042\u306A\u305F\u306E\u5F97\u70B9\u306F".concat(totalScore.toLocaleString(), "\u70B9\u3067\u3059!");
          closePopup.className = "endResultPopup";
          restartBtnTest.addEventListener('click', function gameReStart() {
...
/******/ });
//# sourceMappingURL=typingplay_eng-95553fe19e71c14b7ac6.js.map