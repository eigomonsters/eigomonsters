    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        if (questionOrderMode == "番号順") {
          ...
          displayWordInList = wordList[sortById]; // 同じ問題を２度出題しないように、一度出題した問題はwordListから削除する。

          wordList.splice(sortById, 1);
          ...
          displayWordInList = wordList[randomIntegerInTotalWordList]; // 同じ問題を２度出題しないように、一度出題した問題はwordListから削除する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-e7264a62f098983ec9d5.js.map