...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      var word = charArrayInDisplayWord[0].textContent + charArrayInDisplayWord[1].textContent;
      console.log(word);

      if (word === "きょ" && keyDownChar.key === "k") {} // if(keyDownChar.key === charArrayInDisplayWord[0].textContent && playEndFlag==="0") {
      //   // 文字色を変更する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-1dc76faad7e2bc0fb2e2.js.map