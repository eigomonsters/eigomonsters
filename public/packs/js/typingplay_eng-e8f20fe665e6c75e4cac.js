...
function gameStart() {
  ...
  function countDownTimeToStart() {
    // もう一度遊ぶを実施した際に、ゲーム開始までのカウントダウンとメーターを表示させる処理
    var countDownPopup = document.getElementById("countDownPopup");
    var countDownPopupNumber = 4;
    countDownPopup.className = "countDownPopup";
    countDownPopup.textContent = countDownPopupNumber;
    document.getElementById("meterImg").src = imgArray[bonusCountMeter]; // カウントダウン文字を１ずつ減らす。
...
/******/ });
//# sourceMappingURL=typingplay_eng-e8f20fe665e6c75e4cac.js.map