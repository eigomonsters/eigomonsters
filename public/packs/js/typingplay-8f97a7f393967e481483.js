...
window.addEventListener('load', function () {
  ...
  var countDown = function countDown() {
    ...
    var label = "\u6B8B\u308A".concat(remainSec, "\u79D2"); //   if (remainMSec <= 0){
  ...
  setInterval(countDown, 1000); // let point = document.getElementById("point");
  // let score = 0;
  // const textLength = 4;
  ...
  var bonusCountMeter = 0;
  var bonusCountMeterMax = 10;
...
/******/ });
//# sourceMappingURL=typingplay-8f97a7f393967e481483.js.map