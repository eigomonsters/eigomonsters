...
gameStart(); // window.addEventListener('DOMContentLoaded', function(){
// 	console.log("DOMContentLoaded：HTMLを読み込みました。");
// });

function gameStart() {
  console.log('gameStartの中身が実行されました'); // 表示する単語リストを定義する。
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        setTimeout(function () {
          ...
          closePopup.className = "endResultPopup"; //   restartBtn.addEventListener('click', function gameReStart(){
          // 	console.log('クリックされました！');
          // 	gameStart();
          //   });

          restartBtn.innerHTML = "<a href='./typingplay_eng'>もう一度遊ぶ</a>";
          restartBtn.className = "restartBtn"; // 	restartBtn.addEventListener('click', function gameReStart(){
...
/******/ });
//# sourceMappingURL=typingplay_eng-1454eaa617dba05589ac.js.map