...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    circleImg.classList.add('transparent'); // 表示する"答えを見る"ボタンを定義する。

    var answerButton = document.getElementById("answerButton");
    answerButton.classList.add('transparent'); // 表示するスコアを定義する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-bd23b75425c13b663b6c.js.map