...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    displayWord.className = "displayWord"; // const displayWordEnglish = document.getElementById("displayWordEnglish");
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        remainPlayingTime.innerHTML = ""; // 現在のスコア（左上）の表示を消す。
        ...
        displayWordKanji.textContent = ""; // 答えを見るボタンを消す。
...
/******/ });
//# sourceMappingURL=typingplay_jap-5e1b19fe1db0d68283d2.js.map