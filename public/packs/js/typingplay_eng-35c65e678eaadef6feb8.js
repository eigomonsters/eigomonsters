...
window.addEventListener('beforeunload', function gameStart() {
  // 表示する単語リストを定義する。
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        setTimeout(function () {
          ...
          closePopup.className = "endResultPopup"; //   restartBtnTest.addEventListener('click', function gameReStart(){
...
/******/ });
//# sourceMappingURL=typingplay_eng-35c65e678eaadef6feb8.js.map