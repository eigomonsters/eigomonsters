  ...
  function typingPlayStart() {
    ...
    if (playMode == "普通" || playMode == "タイムアタック") {
      ...
      answerButton.onclick = function () {
        ...
        answerOpenFlag = "1";
        allQuestionWordsList.splice(allQuestionWordsList.length, 1, "1");
      };
    } else {
      // (プレイモード練習の時)
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        ; // 出題した英単語displayWordInList を allQuestionWordsList に格納する。

        allQuestionWordsList.push([displayWordInList.id, displayWordInList.eng_word, displayWordInList.jap_trans_1]);
        console.log(allQuestionWordsList); // 英単語を生成した際に、発音させる。（発音ありの場合のみ）
...
/******/ });
//# sourceMappingURL=typingplay_jap-33479d414eb49979c22f.js.map