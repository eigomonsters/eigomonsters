...
window.addEventListener('load', function () {
  ...
  var initialPlayingTimeMSec = 6000; // 残りのプレイ可能時間に初期値を表示するために、スタート時にもcountDownTimeメソッドを実施する。

  countDownTime(); // const closePopup = document.getElementById("closePopup");
  // let endFlag = "0";
...
/******/ });
//# sourceMappingURL=typingplay-a4ecdcdd9436984230c5.js.map