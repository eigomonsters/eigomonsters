  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      if (charArrayInDisplayWordJap[1].textContent === "ぁ" || charArrayInDisplayWordJap[1].textContent === "ぃ" || charArrayInDisplayWordJap[1].textContent === "ぅ" || charArrayInDisplayWordJap[1].textContent === "ぇ" || charArrayInDisplayWordJap[1].textContent === "ぉ" || charArrayInDisplayWordJap[1].textContent === "ゃ" || charArrayInDisplayWordJap[1].textContent === "ゅ" || charArrayInDisplayWordJap[1].textContent === "ょ" || charArrayInDisplayWordJap[1].textContent === "っ") {
        var _wordLetter = charArrayInDisplayWordJap[0].textContent + charArrayInDisplayWordJap[1].textContent;

        if (shiftAlreadyStartedFlag === 0) {
          charArrayInDisplayWordAlpha = romaMappingTable[_wordLetter].split("").map(function (value) {
        ...
        ;
      } else if (charArrayInDisplayWordJap[1].textContent === "あ" || charArrayInDisplayWordJap[1].textContent === "い" || charArrayInDisplayWordJap[1].textContent === "う" || charArrayInDisplayWordJap[1].textContent === "え" || charArrayInDisplayWordJap[1].textContent === "お") {
        var _wordLetter2 = charArrayInDisplayWordJap[0].textContent;

        if (shiftAlreadyStartedFlag === 0) {
          if (keyDownChar.key === romaMappingTable[_wordLetter2].textContent) {
            charArrayInDisplayWordJap.shift();
          }
      ...
      console.log(charArrayInDisplayWordJap); // if(keyDownChar.key === charArrayInDisplayWordAlpha[0].textContent && playEndFlag==="0") {
      //   // 文字色を変更する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-948203a72548ca155ba4.js.map