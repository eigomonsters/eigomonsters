...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function gameClose() {
      ...
      closePopup.className = "closePopup"; // ゲーム終了後に最終スコアを表示するポップアップを作成する。

      var closePopupScore = document.getElementById("closePopupScore"); // もう一度ボタンを定義する。
      ...
      setTimeout(function () {
        ...
        ;
        closePopupScore.textContent = "".concat(displayNumCorrectWord.textContent, "\uFF1A").concat(displayNumCorrectNum.textContent); // もう一度ボタンの表示（transparentを消して表示させる）
...
/******/ });
//# sourceMappingURL=typingplay_eng-a06192005005f5803732.js.map