...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function displayAnswer() {
      for (var step = 0; step < charArrayInDisplayWordJap.length; step++) {
        charArrayInDisplayWordJap[step].classList.remove('transparent');
      }
    }
...
/******/ });
//# sourceMappingURL=typingplay_jap-1890a7422dfdfad41278.js.map