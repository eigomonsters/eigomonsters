  ...
  function typingPlayStart() {
    ...
    function createDisplayWord(_sortById) {
      ...
      if (playEndFlag === "0") {
        ...
        displayWordInList = wordList[_sortById2];

        var _sortById2 = _sortById2 + 1; // // sortByIdが出題英単語数を超えた場合、初期値に戻す。
...
/******/ });
//# sourceMappingURL=typingplay_jap-4dea6b6e587231ca8cc7.js.map