...
window.addEventListener('load', function () {
  ...
  var bonusAddPlayTime = 3000; // 正誤の初期値を表示する。

  document.getElementById("circle").src = '/assets/正解○.png';
  circle.className = "transparent"; // ゲーム開始までをカウントダウン変数を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-b38003638f4a93ba0629.js.map