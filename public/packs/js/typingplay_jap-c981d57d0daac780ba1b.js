...
window.addEventListener('load', function () {
  ...
  var timerIdToStart = setInterval(countDownTimeToStart, 1000); // 表示する"答えを見る"ボタンを定義する。

  var answerButton = document.getElementById("answerButton");
  answerButton.classList.add('transparent'); // ゲーム開始までをカウントダウンを実施する処理を定義する。
  ...
  function typingPlayStart() {
    ...
    answerButton.classList.remove('transparent');
    answerButton.classList.add('answerButton'); // 表示するスコアを定義する。
    ...
    function countDownTime() {
      ...
      var remainSecLabel = "".concat("00".concat(remainSec).slice(-3));
      ...
      remainPlayingTime.innerHTML = "<span style='font-size:20px;'>\u6B8B\u308A</span>".concat(remainSecLabel, "<span style='font-size:15px;'> \u79D2</span>");
...
/******/ });
//# sourceMappingURL=typingplay_jap-c981d57d0daac780ba1b.js.map