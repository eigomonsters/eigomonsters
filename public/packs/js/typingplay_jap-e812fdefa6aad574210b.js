    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        if (questionOrderMode == "番号順") {
          ...
          console.log(displayWordInList); // プレイモード：タイムアタックの場合は、wordListから表示単語を削除する。
        ...
        ;
        console.log(displayWordInList); // 英単語を生成した際に、発音させる。（発音ありの場合のみ）
...
/******/ });
//# sourceMappingURL=typingplay_jap-e812fdefa6aad574210b.js.map