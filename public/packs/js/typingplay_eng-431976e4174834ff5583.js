...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    var displayNumCorrect = document.getElementById("displayNumCorrect");
    displayNumCorrect.className = "displayNumCorrect"; // 初期値を定義する。

    displayNumCorrect.textContent = 0; // 表示する連続正解数を定義する。

    var displayConsecutiveNumCorrect = document.getElementById("displayConsecutiveNumCorrect");
    displayConsecutiveNumCorrect.className = "displayConsecutiveNumCorrect"; // 初期値を定義する。

    displayConsecutiveNumCorrect.textContent = 0; // 表示する最高連続正解数を定義する。

    var displayMaxConsecutiveNumCorrect = document.getElementById("displayMaxConsecutiveNumCorrect");
    displayMaxConsecutiveNumCorrect.className = "displayMaxConsecutiveNumCorrect"; // 初期値を定義する。

    displayMaxConsecutiveNumCorrect.textContent = 0; // 以上、スコア定義---------------------------------------------------------------------------------------------------
...
/******/ });
//# sourceMappingURL=typingplay_eng-431976e4174834ff5583.js.map