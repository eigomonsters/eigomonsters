...
window.addEventListener('load', function () {
  ...
  function countDownTime() {
    ...
    if (remainMSec <= 0) {
      ...
      var backBtnPopup = document.getElementById("backBtnPopup"); // 2秒後に得点と戻るボタンを表示させる。

      setTimeout(function () {
        closePopup.textContent = "\u3042\u306A\u305F\u306E\u5F97\u70B9\u306F".concat(totalScore, "\u70B9\u3067\u3059!");
        closePopup.className = "endResultPopup";
        backBtnPopup.textContent = "\u30BF\u30A4\u30C8\u30EB\u306B\u623B\u308B";
...
/******/ });
//# sourceMappingURL=typingplay-c2df3dbac59c74be4101.js.map