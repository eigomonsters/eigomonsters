...
window.addEventListener('load', function () {
  ...
  var wordList = [gon.wordlist[0].eng_word, gon.wordlist[1].eng_word, gon.wordlist[2].eng_word]; // 表示するメーターリストを定義する。
...
/******/ });
//# sourceMappingURL=typingplay-ccf8cd9a3b974705057e.js.map