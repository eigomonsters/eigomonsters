...
function gameStart() {
  ...
  var countDownPopupNumber = 2; //   // ゲーム開始までをカウントダウン変数の初期値を表示する。
  ...
  function countDownTimeToStart() {
    console.log(countDownPopupNumber); // ゲーム開始までをカウントダウン変数の初期値を表示する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-cb9f7edc2b8cc3294506.js.map