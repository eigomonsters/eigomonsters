    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      if (charArrayInDisplayWordJap[0].textContent === "っ") {
        ...
        if (charArrayInDisplayWordJap[1] != null) {
          if (keyDownChar.key !== "a" && keyDownChar.key !== "i" && keyDownChar.key !== "u" //&& keyTempForSmallTsuPreSecond !== "t")
          && keyDownChar.key !== "e" && keyDownChar.key !== "o" && keyDownChar.key !== "n") {
            ...
            if (shiftAlreadyStartedCountAll === 0) {
              ...
              if (keyDownChar.key === keyTempForSmallTsuPreFirst) {
                ...
                correctTyping();
                keyDownCharCountUp(keyDownChar); // 異なる場合は入力したアルファベットを前回入力アルファベットに上書き
              } else {
                keyTempForSmallTsuPreFirst = keyDownChar.key;
                bonusCountReset();
              } // // "っ"の単独入力を可能にする
...
/******/ });
//# sourceMappingURL=typingplay_jap-93834c96dea0f2b14098.js.map