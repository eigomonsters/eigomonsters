...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function createDisplayWord(sortById) {
      ...
      if (playEndFlag === "0") {
        ...
        var displayWordInList = wordList[_sortById];

        var _sortById = _sortById + 1; // sortByIdが出題英単語数を超えた場合、初期値に戻す。
...
/******/ });
//# sourceMappingURL=typingplay_jap-a9aabbf93655585191c9.js.map