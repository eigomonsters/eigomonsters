...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      var randomIntegerInTotalWordList = Math.floor(Math.random() * gon.wordList.length); // 表示する単語を一文字ごとに区切り、spanタグで閉じる。
      // spanタグで閉じた単語を表示する。
...
/******/ });
//# sourceMappingURL=typingplay-9707da32c041b119bef5.js.map