...
function keyDownGameStart(keyDownEnter) {
  if ((keyDownEnter.key === 'Enter' || keyDownEnter.key === " ") && gameStartEnterOnlyOnce == "0") {
    ...
    if (pronounceMode == "発音あり" || bgmMode == "BGMあり" || typeAudioMode == "タイプ音あり" || correctAudioMode == "正解音あり" || incorrectAudioMode == "ミス音あり") {
...
/******/ });
//# sourceMappingURL=typingplay_jap-802a483914a0437d81ba.js.map