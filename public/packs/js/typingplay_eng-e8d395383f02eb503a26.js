...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function correctTyping() {
      ...
      console.log(charArrayInDisplayWord[0]);
      console.log(charArrayInDisplayWord[1]);

      if (!(charArrayInDisplayWord[0] == "f" && charArrayInDisplayWord[1] == "f")) {
        charArrayInDisplayWord[0].className = "add_red";
        charArrayInDisplayWord[1].className = "add_gray";
      } else {
        console.log("ff");
      }
      ...
      charArrayInDisplayWord[0].className = "add_gray"; // メーターを更新する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-e8d395383f02eb503a26.js.map