  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        var _sortById2 = 0;
        console.log(_sortById2); // 英単語を順番に出題する場合の番号の初期値を定義する。

        displayWordInList = wordList[_sortById2];
        _sortById2++;
        console.log(_sortById2); // // sortByIdが出題英単語数を超えた場合、初期値に戻す。
...
/******/ });
//# sourceMappingURL=typingplay_jap-c1e39e1f77cb1cc3e131.js.map