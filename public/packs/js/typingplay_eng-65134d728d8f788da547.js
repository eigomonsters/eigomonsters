...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function gameClose() {
      ...
      var backBtn = document.getElementById("backBtn"); // 問題の振り返りボタンを定義する。
      ...
      setTimeout(function () {
        ...
        backBtn.classList.remove('transparent'); // 問題の振り返りボタンの表示（transparentを消して表示させる）

        checkQuestions.classList.remove('transparent');
...
/******/ });
//# sourceMappingURL=typingplay_eng-65134d728d8f788da547.js.map