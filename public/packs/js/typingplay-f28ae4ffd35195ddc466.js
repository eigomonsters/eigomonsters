...
window.addEventListener('load', function () {
  var wordList = ["aaa", "bbb", "ccc", "ddd", "eeeeee", "ffffff", "gggggg", "hhhhhh"]; // 表示単語を定義
  ...
  function createText() {
    ...
    checkTexts = wordList[randomIntegerInTotalWordList].split("").map(function (value) {
      console.log(wordList[randomIntegerInTotalWordList]); // 例) spanValue = <span>a</span>

      var spanValue = document.createElement("span");
      console.log(spanValue);
      console.log(checkTexts); // 例) value = a

      spanValue.textContent = value; // ""のdisplayWordに<span>a</span>を追加する。
  ...
  console.log(checkTexts); // let time = document.getElementById("time");
...
/******/ });
//# sourceMappingURL=typingplay-f28ae4ffd35195ddc466.js.map