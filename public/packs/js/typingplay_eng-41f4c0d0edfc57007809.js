    ...
    function gameClose() {
      ...
      if (bgmMode == "BGMあり") {
        ...
        var stop_func = setInterval(function () {
          bgmAudio.volume = bgmAudio.volume - fadeOutVol / 100;
          console.log(bgmAudio.volume);

          if (bgmAudio.volume <= 0.3) {
            console.log("stop");
            bgmAudio.pause();
...
/******/ });
//# sourceMappingURL=typingplay_eng-41f4c0d0edfc57007809.js.map