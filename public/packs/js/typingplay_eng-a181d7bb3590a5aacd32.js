...
function gameStart() {
  ...
  var timerIdToStart = setTimeout(setInterval(countDownTimeToStart, 1000), 1000); // ゲーム開始までをカウントダウンを実施する処理を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-a181d7bb3590a5aacd32.js.map