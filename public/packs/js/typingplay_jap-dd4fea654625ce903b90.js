...
function gameStart() {
  ...
  var _sortById = 116; // 表示するメーター初期値を定義する。
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      if (playEndFlag === "0") {
        // キーボード音を定義する。
        var keyboardAudio = new Audio('/assets/キーボード音.mp3'); // キーボード音を発生させる。

        keyboardAudio.play(); // 文字によって、文字列の最後にあるかどうかで入力形式が変わるため、"っ""ん"は個別に処理を定義する。
        // 先頭文字が小さい"っ"の場合
...
/******/ });
//# sourceMappingURL=typingplay_jap-dd4fea654625ce903b90.js.map