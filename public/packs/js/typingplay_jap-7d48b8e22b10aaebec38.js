  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        answerButton.remove(); // ゲーム終了後にplayEndFlagを1に更新する。
        ...
        setTimeout(function () {
          ...
          restartBtn.innerHTML = "<a href='./typingplay_index'>もう一度遊ぶ</a>";
          restartBtn.className = "restartBtn";
          backBtn.innerHTML = "<a href='../../'>トップページに戻る</a>";
...
/******/ });
//# sourceMappingURL=typingplay_jap-7d48b8e22b10aaebec38.js.map