...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      if (charArrayInDisplayWord[0].textContent + charArrayInDisplayWord[1].textContent === "きょ" && keyDownChar.key === "kyo") {} // if(keyDownChar.key === charArrayInDisplayWord[0].textContent && playEndFlag==="0") {
      //   // 文字色を変更する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-7ea15aa6d1ce88552e2a.js.map