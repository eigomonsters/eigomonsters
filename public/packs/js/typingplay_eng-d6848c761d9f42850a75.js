  ...
  function typingPlayStart() {
    ...
    function correctTyping() {
      ...
      if (charArrayInDisplayWord.length === 0) {
        ...
        eachQuestionAnswerTime = Date.now() - eachQuestionCreateTime;
        allQuestionWords.splice(allQuestionWords.length - 1, 1, eachQuestionAnswerTime); // 出題したすべての英単語リストに追加する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-d6848c761d9f42850a75.js.map