...
window.addEventListener('load', function () {
  ...
  console.log(p);
  var img = document.getElementById("meterImg"); // img.src = "/app/assets/images/logotest.png";
  ...
  //   image_tag('メーターPNG/メーター0.png'),
  //   image_tag('メーターPNG/メーター10.png')
  // ]
  // document.getElementById("meterImg").src=imgArray[bonusCount];
...
/******/ });
//# sourceMappingURL=typingplay-826f12f7a26b69f6e23e.js.map