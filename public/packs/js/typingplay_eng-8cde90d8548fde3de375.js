...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function gameClose() {
      ...
      var checkQuestions = document.getElementById("checkQuestions");
      checkQuestions.textContent = "問題を振り返る"; // 出題問題リスト表示を定義する。
      ...
      allQuestionsList.innerHTML = allQuestionWordsList; // リストを入れる。
...
/******/ });
//# sourceMappingURL=typingplay_eng-8cde90d8548fde3de375.js.map