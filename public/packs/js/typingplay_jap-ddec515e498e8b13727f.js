...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    answerButton.onclick = displayAnswer(); // 表示するスコアを定義する。
    ...
    function displayAnswer() {
      for (var step = 0; step < charArrayInDisplayWordJap.length; step++) {//charArrayInDisplayWordJap[step].classList.remove('transparent');
      }
    }
...
/******/ });
//# sourceMappingURL=typingplay_jap-ddec515e498e8b13727f.js.map