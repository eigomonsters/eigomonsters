    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      if (shiftAlreadyStartedCountAll === 0) {
        ...
        if (charArrayInDisplayWordJap[1] != null) {
          ...
          var wordLetterWithSmallLetter = charArrayInDisplayWordJap[0].textContent + charArrayInDisplayWordJap[1].textContent; // 文字をローマ字に変換し、アルファベットごとに分ける。
...
/******/ });
//# sourceMappingURL=typingplay_jap-ae0249ba0a41d5657f23.js.map