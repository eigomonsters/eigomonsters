...
window.addEventListener('load', function () {
  ...
  var romajiMappingTable = (_romajiMappingTable = {
    "あ": "a",
    "きょ": "kyo",
    "じゅ": "zyu"
  }, _defineProperty(_romajiMappingTable, "\u3058\u3085", "ju"), _defineProperty(_romajiMappingTable, "え", "e"), _romajiMappingTable); // 表示するメーター初期値を定義する。
  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      charArrayInDisplayWord = displayWordInList.jap_trans_1_yomi.split("").map(function (value) {
        // spanタグを作成する。
    ...
    function keyDownCharCountUp(keyDownChar) {
      var wordLetter = charArrayInDisplayWord[0].textContent + charArrayInDisplayWord[1].textContent;
      console.log(romajiMappingTable[wordLetter]);

      if (romajiMappingTable[wordLetter] === "きょ") {} // if(keyDownChar.key === charArrayInDisplayWord[0].textContent && playEndFlag==="0") {
      //   // 文字色を変更する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-31c7db11838ed69e49c4.js.map