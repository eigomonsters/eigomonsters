...
function gameStart() {
  ...
  var wordList = gon.wordListLevel1; // 表示するメーターリストを定義する。
  ...
  function typingPlayStart() {
    ...
    ; // // タイプした文字が表示文字と不一致の場合の処理を定義する。メーターを0にリセットする処理。
...
/******/ });
//# sourceMappingURL=typingplay_eng-bad61a6d354ae6998bfe.js.map