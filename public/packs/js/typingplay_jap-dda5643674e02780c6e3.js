...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    var displayWordAlpha = document.getElementById("displayWordAlpha"); // タイプした文字が表示文字と一致する場合の処理を定義する。
    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      console.log(displayWordAlpha);
      console.log(charArrayInDisplayWordAlpha); // if(keyDownChar.key === charArrayInDisplayWordAlpha[0].textContent && playEndFlag==="0") {
      //   // 文字色を変更する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-dda5643674e02780c6e3.js.map