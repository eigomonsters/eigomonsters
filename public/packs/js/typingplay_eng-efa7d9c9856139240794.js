...
function gameStart() {
  ...
  var meterImg = document.getElementById("meterImg");
  meterImg.src = imgArray[bonusCountMeter]; // ゲーム開始までをカウントダウン変数を定義する。
  ...
  function typingPlayStart() {
    ...
    if (playMode == "普通" || playMode == "タイムアタック") {
      ...
      answerButton.onclick = function () {
        ...
        bonusCountMeter = 0;
        meterImg = imgArray[bonusCountMeter]; // 「答えを見る」判定フラグを更新する。
    ...
    function gameClose() {
      ...
      setTimeout(function () {
        ...
        checkQuestions.onclick = function () {
          ...
          allQuestionsList.className = "allQuestionsList";
    ...
    function correctTyping() {
      ...
      meterImg = imgArray[bonusCountMeter]; // 表示文字全てタイプした場合、スコアアップ処理を実施し、次の表示文字を作成する処理を実施する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-efa7d9c9856139240794.js.map