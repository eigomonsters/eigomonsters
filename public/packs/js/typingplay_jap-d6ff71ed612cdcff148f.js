...
function gameStart() {
  ...
  var correctAudio = Audio('/assets/正解音.mp3'); // 不正解音を定義する。

  var incorrectAudio = Audio('/assets/不正解音.mp3'); // 表示するメーター初期値を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_jap-d6ff71ed612cdcff148f.js.map