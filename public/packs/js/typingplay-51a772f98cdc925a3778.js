...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      displayWordJapanese = displayWordInList.jap_trans_1;
      console.log(displayWordJapanese); // 表示する単語を一文字ごとに区切り、spanタグで閉じる。
      // spanタグで閉じた単語を表示する。
...
/******/ });
//# sourceMappingURL=typingplay-51a772f98cdc925a3778.js.map