  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        if (playMode == "普通" || playMode == "正確重視") {
          answerButton.className('transparent'); //displayWordAnnotation.remove();
        }

        ; // 正解時に表示される○の画像を消す。

        circleImg.classList.add('transparent'); // ゲーム終了後に終了を知らせるポップアップを作成する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-0141ba0bd59b1502f937.js.map