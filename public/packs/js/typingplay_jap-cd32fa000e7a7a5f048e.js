...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function createDisplayWord() {
      ...
      if (playEndFlag === "0") {
        ...
        var pronounce = function pronounce(eng_word) {
          // function fileCheck(){
          // 	var filepath = new File("file:///sample.txt");
          ...
          // };
          // fileCheck();
          var filepath = new File(["foo"], '/assets/' + eng_word + '.mp3');
        ...
        console.log(displayWordInList.eng_word); // 英単語を生成した際に、発音させる。
    ...
    // 	// };
    // 	// fileCheck();
    // 	let filepath = new File('/assets/'+ eng_word + '.mp3');
    // 	if (filepath.exists == true){
...
/******/ });
//# sourceMappingURL=typingplay_jap-cd32fa000e7a7a5f048e.js.map