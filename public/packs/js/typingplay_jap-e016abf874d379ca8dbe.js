...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    remainPlayingTime.innerHTML = "<span style='color: red;'>span要素に変更したよ！</span>";
    ...
    function countDownTime() {
      ...
      remainPlayingTime.innerHTML = "<span style='font-size:30px;'>\u6B8B\u308A</span>".concat(remainSecLabel, "<span style='font-size:30px;'>\u79D2</span>");
...
/******/ });
//# sourceMappingURL=typingplay_jap-e016abf874d379ca8dbe.js.map