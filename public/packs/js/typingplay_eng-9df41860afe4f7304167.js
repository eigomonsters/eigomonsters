...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function countDownTime() {
      ...
      var remainSecLabel = "\u6B8B\u308A".concat("".concat(remainMin).slice(-2), "\u5206").concat("0".concat(remainSec).slice(-2), "\u79D2"); // 残り時間が0になった場合の処理を定義する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-9df41860afe4f7304167.js.map