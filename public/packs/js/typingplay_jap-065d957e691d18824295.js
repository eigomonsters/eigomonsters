    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      if (charArrayInDisplayWordJap[1] != null) {
        ...
        if (charArrayInDisplayWordJap[1].textContent === "ぁ" || charArrayInDisplayWordJap[1].textContent === "ぃ" || charArrayInDisplayWordJap[1].textContent === "ぅ" || charArrayInDisplayWordJap[1].textContent === "ぇ" || charArrayInDisplayWordJap[1].textContent === "ぉ" || charArrayInDisplayWordJap[1].textContent === "ゃ" || charArrayInDisplayWordJap[1].textContent === "ゅ" || charArrayInDisplayWordJap[1].textContent === "ょ") {
          ...
          if (keyDownChar.key === charArrayInDisplayWordAlphaSole[0].textContent && charArrayInDisplayWordAlpha.length !== 0 && charArrayInDisplayWordAlphaSecond.length !== 0 && charArrayInDisplayWordAlphaThird.length !== 0) {
          ...
          if (romaMappingTableSecond[wordLetterSole] != null) {
            if (keyDownChar.key === charArrayInDisplayWordAlphaSoleSecond[0].textContent && charArrayInDisplayWordAlpha.length !== 0 && charArrayInDisplayWordAlphaSecond.length !== 0 && charArrayInDisplayWordAlphaThird.length !== 0 && charArrayInDisplayWordAlphaSole.length !== 0) {
          ...
          if (romaMappingTableThird[wordLetterSole] != null) {
            if (keyDownChar.key === charArrayInDisplayWordAlphaSoleThird[0].textContent && charArrayInDisplayWordAlpha.length !== 0 && charArrayInDisplayWordAlphaSecond.length !== 0 && charArrayInDisplayWordAlphaThird.length !== 0 && charArrayInDisplayWordAlphaSole.length !== 0 && charArrayInDisplayWordAlphaSoleSecond.length !== 0) {
        ...
        if (shiftAlreadyStartedFlag === 0) {
          ...
          if (romaMappingTableFourth[_wordLetter4] != null) {
            charArrayInDisplayWordAlphaFourth = romaMappingTableFourth[_wordLetter4].split("").map(function (value) {
              var spanValue = document.createElement("span");
              spanValue.textContent = value;
              return spanValue;
            });
        ...
        if (romaMappingTableFourth[_wordLetter4] != null) {
          if (keyDownChar.key === charArrayInDisplayWordAlphaFourth[0].textContent && charArrayInDisplayWordAlpha.length !== 0 && charArrayInDisplayWordAlphaSecond.length !== 0 && charArrayInDisplayWordAlphaThird.length !== 0) {
...
/******/ });
//# sourceMappingURL=typingplay_jap-065d957e691d18824295.js.map