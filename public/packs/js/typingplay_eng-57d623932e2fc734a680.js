...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    circleImg.classList.add('transparent'); // "ヒントを見る"ボタンを表示する。(プレイモード普通、正確重視の時のみ)
    ...
    function countDownTime() {
      ...
      if (remainMSec <= 0) {
        ...
        displayWordJapanese.textContent = ""; // ヒントを見るボタンを消す。（プレイモード普通、正確重視の時のみ）
...
/******/ });
//# sourceMappingURL=typingplay_eng-57d623932e2fc734a680.js.map