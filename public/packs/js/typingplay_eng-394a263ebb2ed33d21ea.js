...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    function correctTyping() {
      ...
      if (agent.indexOf("chrome") != -1 && charArrayInDisplayWord[0].textContent == "f" && charArrayInDisplayWord[1].textContent == "f") {
        charArrayInDisplayWord[0].className = "addHalfRed";
      } else if (agent.indexOf("chrome") != -1 // "addHalfRed適応後に、２つ目の"f"押下でadd_redに戻す。
      && charArrayInDisplayWord[0].textContent == "f") {
        charArrayInDisplayWord[0].className = "transparent";
      } else {
...
/******/ });
//# sourceMappingURL=typingplay_eng-394a263ebb2ed33d21ea.js.map