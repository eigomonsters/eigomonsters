    ...
    function keyDownCharCountUp(keyDownChar) {
      ...
      if (charArrayInDisplayWordJap[1] != null) {
        ...
        if (shiftAlreadyStartedCountAll === 0) {
          ...
          if (romaMappingTableFourth[_wordLetter] != null) {
            charArrayInDisplayWordAlphaFourth = romaMappingTableFourth[_wordLetter].split("").map(function (value) {
              var spanValue = document.createElement("span");
              spanValue.textContent = value;
              return spanValue;
            });
...
/******/ });
//# sourceMappingURL=typingplay_jap-aec5ad79cd18543be925.js.map