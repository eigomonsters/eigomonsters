...
console.log(wordList); // 選択したプレイモードによって変わるplayModeの定義
...
function gameStart() {
  ...
  function typingPlayStart() {
    ...
    var initialPlayingTimeMSec = 3000; // スタート時に残りのプレイ可能時間の初期値を表示するためにcountDownTimeを実施する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-780421485d474de19792.js.map