...
window.addEventListener('load', function () {
  ...
  var imgArray = [image_tag('メーターPNG/メーター0.png'), "./メーターPNG/メーター10.png", "./メーターPNG/メーター20.png", "./メーターPNG/メーター30.png", "./メーターPNG/メーター40.png", "./メーターPNG/メーター50.png", "./メーターPNG/メーター60.png", "./メーターPNG/メーター70.png", "./メーターPNG/メーター80.png", "./メーターPNG/メーター90.png", "./メーターPNG/メーター100.png"];
  document.getElementById("meterImg").src = imgArray[bonusCount];
});
...
/******/ });
//# sourceMappingURL=typingplay-71efa9070aca6c3934ed.js.map