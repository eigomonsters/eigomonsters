...
window.addEventListener('load', function () {
  ...
  function typingPlayStart() {
    ...
    function keyDownCharCountUp(keyDownChar) {
      console.log("All" + shiftAlreadyStartedCountAll);
      console.log("First" + shiftAlreadyStartedCountFirst);
      console.log("Second" + shiftAlreadyStartedCountSecond);
      console.log("Third" + shiftAlreadyStartedCountThird);
      console.log("SoleFirst" + shiftAlreadyStartedCountSoleFirst);
      console.log("SoleSecond" + shiftAlreadyStartedCountSoleSecond);
      console.log("SoleThird" + shiftAlreadyStartedCountSoleThird); // 最後の文字でない場合
...
/******/ });
//# sourceMappingURL=typingplay_jap-eeacd3d01a1a228c3283.js.map