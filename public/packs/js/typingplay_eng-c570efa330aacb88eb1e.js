...
function gameStart() {
  console.log('gameStartの中身が実行されました');
  document.getElementById("meterImg").src = imgArray[bonusCountMeter]; // 表示する単語リストを定義する。
...
/******/ });
//# sourceMappingURL=typingplay_eng-c570efa330aacb88eb1e.js.map